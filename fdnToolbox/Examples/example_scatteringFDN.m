...
numStages = 3; % relates to the filter length
...
for it = 1:length(matrixTypes)
   ...
   switch type
       case 'RandomDense'
           ...
           % sparsity = 3; 
           % feedbackMatrix = zFIR(constructCascadedParaunitaryMatrix(N,numStages, 'sparsity', sparsity,'matrixType','Householder'));
       case 'Velvet'
           sparsity = 3;
   ...
   irTimeDomainMod.(type) = dss2impz_mod(impulseResponseLength, delays, feedbackMatrix, inputGain, outputGain, direct);
