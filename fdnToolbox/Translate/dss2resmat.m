function [residues, poles, matrixRes, direct, isConjugatePolePair, metaData] = dss2resmat(delays,A,B,C,D,varargin)
...
%% Compute residues
[residues,direct,undrivenResidues,matrixRes] = dss2res_mod(poles,loopMatrix,B,C,D);
